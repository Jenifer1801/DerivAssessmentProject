...
Logout from the application
    ...
    ${loginPage}=   Get text    //h5[@class='oxd-text oxd-text--h5 orangehrm-login-title']
    Should be equal  ${loginPage}   Login
